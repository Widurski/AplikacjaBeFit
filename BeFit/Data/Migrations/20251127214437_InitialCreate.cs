        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Komentarz = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CwiczeniaWSesji", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CwiczeniaWSesji_SesjeTreningowe_SesjaTreningowaId",
                        column: x => x.SesjaTreningowaId,
                        principalTable: "SesjeTreningowe",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CwiczeniaWSesji_TypyCwiczen_TypCwiczeniaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CwiczeniaWSesji_SesjaTreningowaId",
                table: "CwiczeniaWSesji",
                column: "SesjaTreningowaId");

            migrationBuilder.CreateIndex(
                name: "IX_CwiczeniaWSesji_TypCwiczeniaId",
                table: "CwiczeniaWSesji",
